...
def listar():
    ...
    produtos = cursor.fetchall() #o método .ftechall() transforma o retorno da execução do BD numa lista
...
def atualizar():
    ...
    preco = float(input('Infomre o novo preço do produto: '))
